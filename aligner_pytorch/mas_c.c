...
{
    "distutils": {
        "name": "aligner_pytorch.mas_c",
        "sources": [
            "aligner_pytorch/mas_c.pyx"
        ]
    },
    "module_name": "aligner_pytorch.mas_c"
}
END: Cython Metadata */
...
#define __PYX_HAVE__aligner_pytorch__mas_c
#define __PYX_HAVE_API__aligner_pytorch__mas_c
/* Early includes */
#include "pythread.h"
#include <string.h>
#include <stdlib.h>
...
/* Module declarations from 'aligner_pytorch.mas_c' */
...
static void __pyx_f_15aligner_pytorch_5mas_c_compute_mas_values(__Pyx_memviewslice, int, int); /*proto*/
static void __pyx_f_15aligner_pytorch_5mas_c_compute_mas_path(__Pyx_memviewslice, __Pyx_memviewslice, int, int); /*proto*/
static void __pyx_f_15aligner_pytorch_5mas_c_compute_mas_alignement(__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "aligner_pytorch.mas_c"
extern int __pyx_module_is_main_aligner_pytorch__mas_c;
int __pyx_module_is_main_aligner_pytorch__mas_c = 0;

/* Implementation of 'aligner_pytorch.mas_c' */
...
static PyObject *__pyx_pf_15aligner_pytorch_5mas_c_compute_mas_alignement(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_paths, __Pyx_memviewslice __pyx_v_values, __Pyx_memviewslice __pyx_v_ms, __Pyx_memviewslice __pyx_v_ns); /* proto */
...
static void __pyx_f_15aligner_pytorch_5mas_c_compute_mas_values(__Pyx_memviewslice __pyx_v_values, int __pyx_v_m, int __pyx_v_n) {
  int __pyx_v_i;
  int __pyx_v_j;
  int __pyx_t_1;
  int __pyx_t_2;
 ...
 */
    ...
    __pyx_t_8 = 0;
    __pyx_t_9 = __pyx_v_j;
    *((float *) ( /* dim=1 */ ((char *) (((float *) ( /* dim=0 */ (__pyx_v_values.data + __pyx_t_8 * __pyx_v_values.strides[0]) )) + __pyx_t_9)) )) = ((*((float *) ( /* dim=1 */ ((char *) (((float *) ( /* dim=0 */ (__pyx_v_values.data + __pyx_t_4 * __pyx_v_values.strides[0]) )) + __pyx_t_5)) ))) + (*((float *) ( /* dim=1 */ ((char *) (((float *) ( /* dim=0 */ (__pyx_v_values.data + __pyx_t_6 * __pyx_v_values.strides[0]) )) + __pyx_t_7)) ))));
  }

  /* "aligner_pytorch/mas_c.pyx":16
 *         values[0, j] = values[0, j-1] + values[0, j]
 *
 *     for i in range(1, m):             # <<<<<<<<<<<<<<
 *         for j in range(i, n):
 ...
 */
      ...
      __pyx_t_13 = (*((float *) ( /* dim=1 */ ((char *) (((float *) ( /* dim=0 */ (__pyx_v_values.data + __pyx_t_5 * __pyx_v_values.strides[0]) )) + __pyx_t_4)) )));
      __pyx_t_4 = (__pyx_v_i - 1);
      __pyx_t_5 = (__pyx_v_j - 1);
      __pyx_t_14 = (*((float *) ( /* dim=1 */ ((char *) (((float *) ( /* dim=0 */ (__pyx_v_values.data + __pyx_t_4 * __pyx_v_values.strides[0]) )) + __pyx_t_5)) )));
      ...
      __pyx_t_5 = __pyx_v_i;
      __pyx_t_4 = __pyx_v_j;
      *((float *) ( /* dim=1 */ ((char *) (((float *) ( /* dim=0 */ (__pyx_v_values.data + __pyx_t_5 * __pyx_v_values.strides[0]) )) + __pyx_t_4)) )) = ((*((float *) ( /* dim=1 */ ((char *) (((float *) ( /* dim=0 */ (__pyx_v_values.data + __pyx_t_7 * __pyx_v_values.strides[0]) )) + __pyx_t_6)) ))) + __pyx_t_15);
    }
  }
...
static void __pyx_f_15aligner_pytorch_5mas_c_compute_mas_path(__Pyx_memviewslice __pyx_v_path, __Pyx_memviewslice __pyx_v_values, int __pyx_v_m, int __pyx_v_n) {
  int __pyx_v_i;
  int __pyx_v_j;
  int __pyx_t_1;
 ...
 */
    __pyx_t_2 = __pyx_v_i;
    __pyx_t_3 = __pyx_v_j;
    *((int *) ( /* dim=1 */ ((char *) (((int *) ( /* dim=0 */ (__pyx_v_path.data + __pyx_t_2 * __pyx_v_path.strides[0]) )) + __pyx_t_3)) )) = 1;

    /* "aligner_pytorch/mas_c.pyx":29
 *     for j in reversed(range(n)):
 *         path[i, j] = 1
 *         if i != 0 and (i == j or values[i, j-1] < values[i-1, j-1]):             # <<<<<<<<<<<<<<
 *             i -= 1
 ...
 */
    ...
    __pyx_t_5 = (((*((float *) ( /* dim=1 */ ((char *) (((float *) ( /* dim=0 */ (__pyx_v_values.data + __pyx_t_3 * __pyx_v_values.strides[0]) )) + __pyx_t_2)) ))) < (*((float *) ( /* dim=1 */ ((char *) (((float *) ( /* dim=0 */ (__pyx_v_values.data + __pyx_t_6 * __pyx_v_values.strides[0]) )) + __pyx_t_7)) )))) != 0);
    __pyx_t_4 = __pyx_t_5;
    __pyx_L6_bool_binop_done:;
    if (__pyx_t_4) {

      /* "aligner_pytorch/mas_c.pyx":30
 *         path[i, j] = 1
 *         if i != 0 and (i == j or values[i, j-1] < values[i-1, j-1]):
 *             i -= 1             # <<<<<<<<<<<<<<
 *
...
static PyObject *__pyx_pw_15aligner_pytorch_5mas_c_1compute_mas_alignement(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static void __pyx_f_15aligner_pytorch_5mas_c_compute_mas_alignement(__Pyx_memviewslice __pyx_v_paths, __Pyx_memviewslice __pyx_v_values, __Pyx_memviewslice __pyx_v_ms, __Pyx_memviewslice __pyx_v_ns, CYTHON_UNUSED int __pyx_skip_dispatch) {
 ...
 */
  {
      ...
      /*try:*/ {
        ...
        if ((1 == 0)) abort();
        {
            ...
            {
                #ifdef _OPENMP
                #pragma omp parallel private(__pyx_t_5, __pyx_t_6) firstprivate(__pyx_t_4, __pyx_t_7)
                #endif /* _OPENMP */
                {
                    #ifdef _OPENMP
...
__pyx_t_4.shape[1] = __pyx_v_values.shape[2];
__pyx_t_4.strides[1] = __pyx_v_values.strides[2];
    __pyx_t_4.suboffsets[1] = -1;

__pyx_t_5 = __pyx_v_i;
                            __pyx_t_6 = __pyx_v_i;
                            __pyx_f_15aligner_pytorch_5mas_c_compute_mas_values(__pyx_t_4, (*((int *) ( /* dim=0 */ ((char *) (((int *) __pyx_v_ms.data) + __pyx_t_5)) ))), (*((int *) ( /* dim=0 */ ((char *) (((int *) __pyx_v_ns.data) + __pyx_t_6)) ))));
                            __PYX_XDEC_MEMVIEW(&__pyx_t_4, 0);
                            __pyx_t_4.memview = NULL;
                            __pyx_t_4.data = NULL;

                            /* "aligner_pytorch/mas_c.pyx":40
 *     for i in prange(b, nogil=True):
 *         compute_mas_values(values[i], ms[i], ns[i])
 *         compute_mas_path(paths[i], values[i], ms[i], ns[i])             # <<<<<<<<<<<<<<
 */
...
__pyx_t_7.shape[1] = __pyx_v_paths.shape[2];
__pyx_t_7.strides[1] = __pyx_v_paths.strides[2];
...
__pyx_t_6 = __pyx_v_i;
                            __pyx_t_5 = __pyx_v_i;
                            __pyx_f_15aligner_pytorch_5mas_c_compute_mas_path(__pyx_t_7, __pyx_t_4, (*((int *) ( /* dim=0 */ ((char *) (((int *) __pyx_v_ms.data) + __pyx_t_6)) ))), (*((int *) ( /* dim=0 */ ((char *) (((int *) __pyx_v_ns.data) + __pyx_t_5)) ))));
...
/* Python wrapper */
static PyObject *__pyx_pw_15aligner_pytorch_5mas_c_1compute_mas_alignement(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_15aligner_pytorch_5mas_c_1compute_mas_alignement(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_paths = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_values = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_ms = { 0, 0, { 0 }, { 0 }, { 0 } };
  ...
  __Pyx_RefNannySetupContext("compute_mas_alignement (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_paths,&__pyx_n_s_values,&__pyx_n_s_ms,&__pyx_n_s_ns,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_values)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("compute_mas_alignement", 1, 4, 4, 1); __PYX_ERR(0, 34, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_ms)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("compute_mas_alignement", 1, 4, 4, 2); __PYX_ERR(0, 34, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_ns)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("compute_mas_alignement", 1, 4, 4, 3); __PYX_ERR(0, 34, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "compute_mas_alignement") < 0)) __PYX_ERR(0, 34, __pyx_L3_error)
      }
    ...
    __pyx_v_paths = __Pyx_PyObject_to_MemoryviewSlice_d_d_dc_int(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_paths.memview)) __PYX_ERR(0, 34, __pyx_L3_error)
    __pyx_v_values = __Pyx_PyObject_to_MemoryviewSlice_d_d_dc_float(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_values.memview)) __PYX_ERR(0, 34, __pyx_L3_error)
    __pyx_v_ms = __Pyx_PyObject_to_MemoryviewSlice_dc_int(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_ms.memview)) __PYX_ERR(0, 34, __pyx_L3_error)
    __pyx_v_ns = __Pyx_PyObject_to_MemoryviewSlice_dc_int(values[3], PyBUF_WRITABLE); if (unlikely(!__pyx_v_ns.memview)) __PYX_ERR(0, 34, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("compute_mas_alignement", 1, 4, 4, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 34, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("aligner_pytorch.mas_c.compute_mas_alignement", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_15aligner_pytorch_5mas_c_compute_mas_alignement(__pyx_self, __pyx_v_paths, __pyx_v_values, __pyx_v_ms, __pyx_v_ns);
...
static PyObject *__pyx_pf_15aligner_pytorch_5mas_c_compute_mas_alignement(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_paths, __Pyx_memviewslice __pyx_v_values, __Pyx_memviewslice __pyx_v_ms, __Pyx_memviewslice __pyx_v_ns) {
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("compute_mas_alignement", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_paths.memview)) { __Pyx_RaiseUnboundLocalError("paths"); __PYX_ERR(0, 34, __pyx_L1_error) }
  if (unlikely(!__pyx_v_values.memview)) { __Pyx_RaiseUnboundLocalError("values"); __PYX_ERR(0, 34, __pyx_L1_error) }
  if (unlikely(!__pyx_v_ms.memview)) { __Pyx_RaiseUnboundLocalError("ms"); __PYX_ERR(0, 34, __pyx_L1_error) }
  if (unlikely(!__pyx_v_ns.memview)) { __Pyx_RaiseUnboundLocalError("ns"); __PYX_ERR(0, 34, __pyx_L1_error) }
  __pyx_t_1 = __Pyx_void_to_None(__pyx_f_15aligner_pytorch_5mas_c_compute_mas_alignement(__pyx_v_paths, __pyx_v_values, __pyx_v_ms, __pyx_v_ns, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 34, __pyx_L1_error)
  ...
  __PYX_XDEC_MEMVIEW(&__pyx_v_ms, 1);
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "aligner_pytorch.mas_c.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "aligner_pytorch.mas_c.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "aligner_pytorch.mas_c.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "aligner_pytorch.mas_c._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"compute_mas_alignement", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_15aligner_pytorch_5mas_c_1compute_mas_alignement, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec_mas_c(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_mas_c},
  {0, NULL}
};
#endif
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initmas_c(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initmas_c(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_mas_c(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_mas_c(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_mas_c(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'mas_c' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_mas_c(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("mas_c", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_aligner_pytorch__mas_c) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 2, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 2, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "aligner_pytorch.mas_c")) {
      if (unlikely(PyDict_SetItemString(modules, "aligner_pytorch.mas_c", __pyx_m) < 0)) __PYX_ERR(0, 2, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init aligner_pytorch.mas_c", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init aligner_pytorch.mas_c");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
